...
if(isset($_POST['Submit']) && isset($_POST['IsSubmit']) && $_POST['IsSubmit']=="1"){
	...
	$dbresult = $DBObject->InsertNewCat($catparent,$catname);
	...
	$dbresult = $DBObject->UpdateCatImage($latest_db_id,$finalfilename); // Update Database
	...
	if($dbresult==1 && 	$image_error == 0){
		...
		header("Location:manage_sub_categories.php?pid=".$catparent);
		}
	}else{
