...
if(isset($_POST['Submit']) && isset($_POST['IsSubmit']) && $_POST['IsSubmit']=="1"){
	...
	$dbresult = $DBObject->InsertNewPage2($pagename,$pagetitle,$pagecontent,$pagemetakeys,$pagemetadesc,$parentid);
...
<table width="100%"  border="1" cellpadding="4" cellspacing="4" bgcolor="#6666CC">
  <tr>
    <td class="heading">&nbsp;CMS &gt; ADD NEW SUBPAGE (USEFUL WEBSITES)</td>
  </tr>
      <tr>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
        ...
        <tr valign="top">
          ...
          <td width="30%">&nbsp;
			...
			<?php
			$parentobject = $DBObject->getAllParents2(0);
