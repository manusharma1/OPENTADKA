...
if(isset($_POST['Submit']) && isset($_POST['IsSubmit']) && $_POST['IsSubmit']=="1"){
	...
	$dbresult = $DBObject->EditPage2($pageid,$pagename,$pagetitle,$pagecontent,$pagemetakeys,$pagemetadesc);
	
	if($dbresult==1){
	$_SESSION['message'] = "Page Edited";
	header("Location:edit_page2.php?id=".$pageid);
	}else{
...
<table width="100%"  border="1" cellpadding="4" cellspacing="4" bgcolor="#6666CC">
  <tr>
    <td class="heading">&nbsp;CMS &gt; EDIT PAGE (USEFUL WEBSITES)</td>
  </tr>
      <tr>
