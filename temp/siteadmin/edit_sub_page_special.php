...
if(isset($_POST['Submit']) && isset($_POST['IsSubmit']) && $_POST['IsSubmit']=="1"){
	...
	$dbresult = $DBObject->EditSubPageSpecial($pageid,$pagename,$pagetitle,$pagecontent,$pagemetakeys,$pagemetadesc,$parentid,'0');
	}else{
	$dbresult = $DBObject->EditSubPageSpecial($pageid,$pagename,$pagetitle,$pagecontent,$pagemetakeys,$pagemetadesc,$parentid,'1');
	}
	

	if($dbresult==1){
	$_SESSION['message'] = "Special Sub Page Edited";
	header("Location:edit_sub_page_special.php?id=".$pageid);
	}else{
