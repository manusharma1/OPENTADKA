...
if(isset($_POST['Submit']) && isset($_POST['IsSubmit']) && $_POST['IsSubmit']=="1"){
	...
	$dbresult_check = $DBObject->CheckFSEntry($website,$category);

	if($dbresult_check==0){
	$dbresult = $DBObject->InsertNewFSEntry($category,$name,$website,$description);
...
<table width="100%"  border="1" cellpadding="4" cellspacing="4" bgcolor="#6666CC">
  <tr>
    <td class="heading">&nbsp;CMS &gt; ADD NEW FREESTUFF ENTRY </td>
  </tr>
