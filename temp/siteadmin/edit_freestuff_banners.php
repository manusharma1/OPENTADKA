...
// Delete the existing related images //
			...
			$directory_path = SITE_DOCUMENTROOT.SITE_FOLDERNAME."/BnrImages/BRightSide/FS/";
...
$target_path = SITE_DOCUMENTROOT."/".SITE_FOLDERNAME."/BnrImages/BRightSide/FS/";
...
if(move_uploaded_file($_FILES['rightside_ad1']['tmp_name'], $target_path)) {
	...
	$dbresult = $DBObject->InsertFSBanners($category_id,$finalfilename,$bannerlink1,'1');
...
if(move_uploaded_file($_FILES['rightside_ad2']['tmp_name'], $target_path)) {
	...
	$dbresult = $DBObject->InsertFSBanners($category_id,$finalfilename,$bannerlink2,'2');
...
if(move_uploaded_file($_FILES['rightside_ad3']['tmp_name'], $target_path)) {
	...
	$dbresult = $DBObject->InsertFSBanners($category_id,$finalfilename,$bannerlink3,'3');
...
if(move_uploaded_file($_FILES['rightside_ad4']['tmp_name'], $target_path)) {
	...
	$dbresult = $DBObject->InsertFSBanners($category_id,$finalfilename,$bannerlink4,'4');
      ...
      <tr>
        <td class="heading"><form action="" method="post" enctype="multipart/form-data"  onsubmit="return validate_header_rightside_ads_form(this);"><table width="100%"  border="0" cellpadding="1" cellspacing="1" bgcolor="#FFFFFF">
          ...
          <tr>
			...
			<?php
			$BannerData = $DBObject->getRightPanelFSBanners($category_id,1);
			$rightside_image_file_name_1 = "rightside_ad_1";
			$directory_path = SITE_DOCUMENTROOT.SITE_FOLDERNAME."/BnrImages/BRightSide/FS/";
			...
			for($i=0; $i<count($allowed_file_exts); $i++){
			  ...
			  $rightside_image_file_full_path_name_1 = SITE_HOSTNAME."/".SITE_FOLDERNAME."/BnrImages/BRightSide/FS/".$rightside_image_file_name_1."_".$category_id.".".$allowed_file_exts[$i];
			  }
			}
          ...
          <tr>
			...
			<?php
			$BannerData = $DBObject->getRightPanelFSBanners($category_id,2);
			...
			for($i=0; $i<count($allowed_file_exts); $i++){
			  ...
			  $rightside_image_file_full_path_name_2 = SITE_HOSTNAME."/".SITE_FOLDERNAME."/BnrImages/BRightSide/FS/".$rightside_image_file_name_2."_".$category_id.".".$allowed_file_exts[$i];
			  }
			}
          ...
          <tr>
			...
			<?php
			$BannerData = $DBObject->getRightPanelFSBanners($category_id,3);
			...
			for($i=0; $i<count($allowed_file_exts); $i++){
			  ...
			  $rightside_image_file_full_path_name_3 = SITE_HOSTNAME."/".SITE_FOLDERNAME."/BnrImages/BRightSide/FS/".$rightside_image_file_name_3."_".$category_id.".".$allowed_file_exts[$i];
			  }
			}
          ...
          <tr>
			...
			<?php
			$BannerData = $DBObject->getRightPanelFSBanners($category_id,4);
			...
			for($i=0; $i<count($allowed_file_exts); $i++){
			  ...
			  $rightside_image_file_full_path_name_4 = SITE_HOSTNAME."/".SITE_FOLDERNAME."/BnrImages/BRightSide/FS/".$rightside_image_file_name_4."_".$category_id.".".$allowed_file_exts[$i];
			  }
			}
