...
if(isset($_POST['Submit']) && isset($_POST['IsSubmit']) && $_POST['IsSubmit']=="1"){
	...
	$dbresult = $DBObject->InsertNewFS($catparent,$catname);
	...
	$dbresult = $DBObject->UpdateFSImage($latest_db_id,$finalfilename); // Update Database
	...
	if($dbresult==1 && 	$image_error == 0){
		...
		header("Location:manage_sub_freestuff.php?pid=".$catparent);
		}
	}else{
...
<table width="100%"  border="1" cellpadding="4" cellspacing="4" bgcolor="#6666CC">
  <tr>
    <td class="heading">&nbsp;CMS &gt; ADD NEW CATEGORY </td>
  </tr>
	  <tr>
