...
if(isset($_POST['Submit']) && isset($_POST['IsSubmit']) && $_POST['IsSubmit']=="1"){
	...
	$dbresult = $DBObject->EditCat($catname,$catid);
...
// Delete the existing related images //
	...
	$image_error = 0;
	$dbresult = $DBObject->UpdateCatImage($finalfilename,$catid); // Update Database
	...
	$dbresult = $DBObject->EditCat($catname,$catid);
			...
			header("Location:edit_category.php?id=".$catid);
			}else{
...
<table width="100%"  border="1" cellpadding="4" cellspacing="4" bgcolor="#6666CC">
  <tr>
    <td class="heading">&nbsp;CMS &gt; EDIT CATEGORY </td>
  </tr>
	  <tr>
