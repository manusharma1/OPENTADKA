...
$admin_allowed_modules = array('admin','user','cms','links');

//Allowed Actions, Please add your allowed actions, in the array

$admin_allowed_actions = array('login','logout','loginCheck','getAdminHome','getUserDetails','saveUserDetails','getContent','errorPage','addNewPage','addNewMenu','savePage','saveMenu','editPage','editMenu','managePages','manageMenus','deletePage','deleteMenu','deletePageConfirmed','deleteMenuConfirmed','addNewLink','saveLink','editLink','manageLinks','changeLinkStatus');
