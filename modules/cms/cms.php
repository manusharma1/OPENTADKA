...
public function getContent($id){
	...
	$columns = array('title','metadesc','metakeys','data','data2');
	$conditions = array();
	$conditions['=']['id'] = $id;
	...
	$functionreturnarray['main_contentmore_placeholder'] = $sqlObj->getCleanData($resultset->data2);
...
public function deletePageConfirmed($id){
...
public function deleteMenuConfirmed($id){
