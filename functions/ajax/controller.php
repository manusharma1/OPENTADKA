...
$allowed_actions = array('login','logout','loginCheck','getAdminHome','getContent','errorPage','addNewPage','addNewMenu','savePage','saveMenu','editPage','editMenu','managePages','manageMenus','deletePage','deleteMenu','deletePageConfirmed','deleteMenuConfirmed','ajaxGetPageContent');
