...
define('PROJ_NAME', 'www.opentadka.org');
...
define('PROJ_DBNAME','openorgi_opentadkaorg');
define('PROJ_DBUSER','openorgi_optadka');
define('PROJ_DBPASS','rosOt**$-NC@');
//define('PROJ_DBUSER','root');
//define('PROJ_DBPASS','');
...
//SALT
define('PROJ_SEC_SALT', 'Open~TADKA@Org$5s67%^#%hgh%^%^gs');
...
define('PROJ_ALLOWED_HTML_TAGS', '<a><br>,<blockquote>,<div>,<em>,<h1>,<h2>,<h3>,<h4>,<h5>,<h6><hr>,<img>,<li>,<p>,<span><strong>,<sub>,<sup>,<strike>,<u>,<ul><table><td><th><tr>');
